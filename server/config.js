...
const config = {
  ...
  // The single administrator email. Only this account receives the admin role,
  // assigned server-side — never settable from the frontend.
  adminEmail: (process.env.ADMIN_EMAIL || 'harshavardhangowda525@gmail.com').trim().toLowerCase(),
